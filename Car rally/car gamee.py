...
def game_intro():
    ...
    while intro:
        ...
        text = font.render("CAR RALLY", True, white)
        text1 = font1.render("   an AJ VOZY production", True, white)
        text2 = font1.render("All copyrights reserved @ajvocalz1Pvt. Ltd. 2022", True, white)
